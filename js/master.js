  ...
  window.openMasterBoard = function () {
    ...
    o.innerHTML = '<div style="max-width:860px;margin:0 auto;padding:calc(env(safe-area-inset-top,0px) + 26px) 14px 60px;">' +
      ...
      '<div style="display:flex;gap:8px;margin-bottom:12px;">' +
        '<button onclick="typeof openTargets===\'function\'&&openTargets()" style="flex:1;padding:12px;border-radius:10px;cursor:pointer;' + MONO + 'font-size:11.5px;font-weight:700;background:#0f1a12;border:1.5px solid #2a7a4a;color:#9ad6a0;">🎯 SITE TARGETS →</button>' +
        '<button onclick="typeof openBirdHealth===\'function\'&&openBirdHealth()" style="flex:1;padding:12px;border-radius:10px;cursor:pointer;' + MONO + 'font-size:11.5px;font-weight:700;background:#1c150e;border:1.5px solid #c99a5a;color:#e8c98a;">🐔 BIRD HEALTH →</button>' +
      '</div>' +
