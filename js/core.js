...
const FORM_TEXT = {
  ...
  'Broken Eggs':              { es:'Huevos Rotos' },
  'Houses Ran':               { es:'Galpones Corridos' },
  '+ Add House':              { es:'+ Agregar Galpón' },
  'Barn *':                   { es:'Galpón *' },
  '— Select Barn —':          { es:'— Seleccionar Galpón —' },
  'Barn 1':                   { es:'Galpón 1' },
  'Barn 2':                   { es:'Galpón 2' },
  'Barn 3':                   { es:'Galpón 3' },
  'Barn 4':                   { es:'Galpón 4' },
  ...
  'Barn 7':                   { es:'Galpón 7' },
  'Barn 8':                   { es:'Galpón 8' },
  '📍 Log Hegins Packing':    { es:'📍 Registrar Empaque Hegins' },
  '📍 Log Danville Packing':  { es:'📍 Registrar Empaque Danville' },
  '✓ Save Hegins Entry':      { es:'✓ Guardar Entrada Hegins' },
  '✓ Save Danville Entry':    { es:'✓ Guardar Entrada Danville' },
  'Shift':                    { es:'Turno' },
